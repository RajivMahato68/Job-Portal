        ...
        <form onSubmit={handleRegister}>
            ...
            <div className="inputTag">
              ...
              <div>
                <select value={role} onChange={(e)=> setRole(e.target.value)}>
                  ...
                  <option value="Employer">Register as a Employer</option>
          ...
          <div className="wrapper">
            <div className="inputTag">
              ...
              <div>
              <input type="email" placeholder='gmail@gmail.com' value={email} onChange={(e)=>setEmail(e.target.value)} />
            ...
            <div className="inputTag">
              ...
              <div>
                <input type="number" placeholder='98xxxxxxxx' value={phone} onChange={(e)=>setPhone(e.target.value)} />
                <FaPhoneFlip />
              </div>
            </div>
          </div> 
