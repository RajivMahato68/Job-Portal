...
const JobPost=()=>  {
  ...
  const [introducation,setIntroducation] = useState("");
  ...
  const handlePostJob = (e)=>{
   const formData = new FormData();
    ...
    formData.append("introducation",introducation);
  ...
  return (
    <div className='account_components'>
      ...
      <div>
        <label>Company/Job Introducation</label>
        <textarea type="text" value={introducation} onChange={(e)=> setIntroducation(e.target.value)} placeholder='Enter Company or job Introducation' rows={7}/>
      </div>

      <div>
        <label>Responsibilities</label>
        <textarea type="text" value={responsibilities} onChange={(e)=> setResponsibilities(e.target.value)} placeholder='Job Responsibilities' rows={7}/>
      </div>

      <div>
        <label>Qualifications</label>
        <textarea type="text" value={qualifications} onChange={(e)=> setQualifications(e.target.value)} placeholder='Required Qualifications for Job' rows={7}/>
      </div>
      ...
      <div>
        ...
        <textarea type="text" value={offers} onChange={(e)=> setOffers(e.target.value)} placeholder='What are we offering in return!' rows={7}/>
      </div>
      <div>
      ...
      <div>
        ...
        <input type="text" value={personalWebsiteUrl} onChange={(e)=>setPersonalWebsiteUrl(e.target.value)} placeholder='Personal Website Link (URL)' />
